...
class DivisionMasterController extends Controller
{
	...
	{
		$data = DB::select('select * from division_masters d, stream_masters s where s.s_id=d.s_id');
		return view('admin/viewDivision')->with(['data' => $data, 'stream' => stream_master::get()]);
	}
