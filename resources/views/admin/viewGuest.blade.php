  ...
  <tbody>
    @for($i = 0; $i < count($data); $i++) <tr class="odd gradeX">
      ...
      <td class="col-md-2">
        ...
        <form action="{{ route('admin.deleteguest', [$data[$i]->guest_id]) }}" method="post" style="display: inline;">
          {{csrf_field()}}
          {{ method_field('DELETE') }}
...
<div class="modal fade" id="modal-7">
  <form method="post" id="addguest" action="{{route('admin.addguest')}}">
    {{csrf_field()}}
...
<div class="modal fade" id="modal-6">
  <form method="post" id="updateguest" action="{{route('admin.updateguest')}}">
    {{csrf_field()}}
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
