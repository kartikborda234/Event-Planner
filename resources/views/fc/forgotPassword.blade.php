		...
		<div class="login-container">
			<div class="login-form">
				<div class="login-content">
					<form method="post" action="{{route('fcMail')}}">
						{{ csrf_field() }}
							...
							<div class="step current" id="step-1">
								<div class="form-group">
									<div class="input-group">
										...
										<input type="email" class="form-control" name="email" id="email" placeholder="Email" data-mask="email" autocomplete="off" required="" />
									</div>
								</div>
								<div class="form-group"> <button type="submit" class="btn btn-info btn-block btn-login">
										Forgot Password
										<i class="entypo-right-open-mini"></i> </button> </div>
							</div>
						</div>
					</form>
					<div class="login-bottom-links">
						<a href="/fc" class="link"> <i class="entypo-lock"></i>
