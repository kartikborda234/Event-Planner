...
<div class="modal fade" id="modal-7">
	<form method="post" id="updatePractice" action="{{route('fc.updatePracticeSchedule')}}">
		{{csrf_field()}}
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	...
	$(document).ready(function() {
		$("#addPractice").submit(function(e) {
			...
			if (date == "") {
				...
				e.preventDefault();
				$("#date").after(
					'<span class="error">Date should be today\'s date or Greaterthan today\'s date</span>'
				);
			}
			if (time == "") {
				e.preventDefault();
		...
		$("#updatePractice").submit(function(e) {
