  ...
  <div class="login-container">
    <div class="login-form">
      <div class="login-content">
        ...
        @endif
        <form method="post" action="/fc/authenticate">
          {{ csrf_field() }}
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="hidden" class="form-control" name="u_type" value="2" />
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">
        ...
        <div class="login-bottom-links"> <a href="{{route('fcForgotpassword')}}" class="link">Forgot your password?</a>
        </div>
      </div>
    </div>
