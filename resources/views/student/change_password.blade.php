	...
	<div class="col-lg-6" style="margin: auto;">
		<div class="card">
			...
			<div class="card-block">
				<div class="container">
					<form method="post" id="change_password" action="/student/change_password">
						{{ csrf_field() }}
						...
						<div class="col-md-12 clearfix">
							<button type="submit" name="submit" class="btn btn-success m-2" style="width: 250px;">Submit</button>
							<button type="reset" name="submit" class="btn btn-danger m-2" style="width: 250px;">Clear</button>
						</div>
					</form>
				</div>
			</div>
